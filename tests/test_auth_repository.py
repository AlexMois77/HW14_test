...
class TestUserRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch.object(RoleRepository, 'get_role_by_name', return_value=self.role_mock):
    ...
    def test_get_user(self):
        self.session.execute.return_value.scalar_one_or_none.return_value = self.new_user
    ...
    def test_update_avatar(self):
        ...
        self.assertEqual(self.session.commit.call_count, 2)  # Проверка на 1 вызов commit
...
class TestRoleRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.session.execute.return_value.scalar_one_or_none.return_value = self.role_mock
