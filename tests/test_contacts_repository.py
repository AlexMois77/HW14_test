...
class TestContactsRepository(unittest.TestCase):
    ...
    def test_get_contacts(self):
        self.session.execute.return_value.scalars.return_value.all.return_value = [self.contact_mock]
    ...
    def test_create_contacts(self):
        ...
        contact_create.birthday = self.faker.date_of_birth(minimum_age=18, maximum_age=90)
    ...
    def test_get_contact_by_id_and_owner(self):
        self.session.execute.return_value.scalar_one_or_none.return_value = self.contact_mock
    ...
    def test_update_contact(self):
        ...
        updated_contact = self.repo.update_contact(self.contact_id, self.owner_id, contact_update)
